      ...
      <>
        <div className='sighting-page row u-center-text'>
          ...
          <div className='col-1-of-2'>
            ...
            <img
              className='sighting-page__image'
              src={image}
              alt={commonName}
            ></img>
          ...
          <div className='info'>
            <p>
              <span className='sighting-page-info u-margin-top-medium'>
                Reported by {username}{' '}
              </span>
            </p>
            <p>
              <span className='sighting-page-info u-margin-top-small'>
                Identified?{' '}
                {identified === true ? (
        ...
        <div className='comment-container'>
          ...
          <h4 className='sighting-page-info'>Add Comment:</h4>
...
export default connect(mapStateToProps, { setSelectedSighting, unsetSighting })(
  SightingPage
);
