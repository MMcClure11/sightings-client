    ...
    <div className='card'>
      <div className='card__side card__side--front'>
        ...
        {props.all && (
          <h2 className='heading-tertiary'>
            Reported By: {props.user.username}
          </h2>
        )}
      ...
      <div className='card__side card__side--back'>
        <div className='card__content'>
          ...
          <h4 className='heading-tertiary heading-tertiary--no-margin'>
          ...
          {!props.all && (
            <p className='heading-small'>
              {props.public === true ? 'Public Sighting' : 'Private Sighting'}
            </p>
          )}
          <p className='heading-small'>
            Location: {props.location.city}, {props.location.region},{' '}
            {props.location.country}
          </p>
          <p className='heading-small'>Date seen: {props.date}</p>
          <NavLink to={`/sightings/${props.id}`} className='link'>
            More Info
          </NavLink>
          <span>
            {props.currentOwner && (
