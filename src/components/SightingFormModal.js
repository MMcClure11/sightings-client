        ...
        <form className='sighting-form' onSubmit={onSubmit}>
          <div className='sighting-form__group'>
            <input
              ...
              required={true}
            />
            <label className='sighting-form__label' htmlFor='image'>
              Image URL
            </label>
          </div>
          <div className='sighting-form__group'>
            ...
            <label className='sighting-form__label' htmlFor='category'>
              Category
            </label>
          </div>
          <div className='sighting-form__group'>
            <input
              ...
              value={commonName}
            />
            <label className='sighting-form__label' htmlFor='commonName'>
              Common Name
            </label>
          </div>
          <div className='sighting-form__group'>
            ...
            />
            <label className='sighting-form__label' htmlFor='scientificName'>
              Scientific Name
            </label>
          </div>
          <div className='sighting-form__group'>
            <textarea
              ...
              value={notes}
            ></textarea>
            <label className='sighting-form__label' htmlFor='notes'>
              Notes
            </label>
          </div>
          ...
          <div className='sighting-form__group'>
            <input
              ...
              required={true}
            />
            <label className='sighting-form__label' htmlFor='city'>
              City
            </label>
          </div>
          <div className='sighting-form__group'>
            <input
              ...
              required={true}
            />
            <label className='sighting-form__label' htmlFor='region'>
              Region
            </label>
          </div>
          <div className='sighting-form__group'>
            <input
              ...
              required={true}
            />
            <label className='sighting-form__label' htmlFor='country'>
              Country
            </label>
          </div>
          <div className='sighting-form__group'>
            <input
              ...
              required={true}
            />
            <label className='sighting-form__label' htmlFor='date'>
              Date Seen
            </label>
          </div>
          <div className='sighting-form__group'>
